...
if [ "$CHECK" = true ]; then
  ...
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/main/java/labfive/ \
                                     --checkfiles ManipulateDna.java --singlecomments 4 --multicomments 2 --language Java
  determine_exit_code $?
  # --> GatorGrader CHECK: the "new Date()" fragment exists in the code at least once
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/main/java/labfive \
                                     --checkfiles ManipulateDna.java --fragments "new Date()" --fragmentcounts 1
  determine_exit_code $?
  # --> GatorGrader CHECK: at least 8 "println()" fragment exists in the code
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/main/java/labfive \
                                     --checkfiles ManipulateDna.java --fragments "println(" --fragmentcounts 8
  determine_exit_code $?
  # --> GatorGrader CHECK: at least 5 "String" fragment exists in the code
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/main/java/labfive \
                                     --checkfiles ManipulateDna.java --fragments "String" --fragmentcounts 5
  determine_exit_code $?
  # --> GatorGrader CHECK: at least 3 "nextInt" fragment exists in the code
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/main/java/labfive \
                                     --checkfiles ManipulateDna.java --fragments "nextInt" --fragmentcounts 3
  determine_exit_code $?
  # --> GatorGrader CHECK: at least 2 "charAt" fragment exists in the code
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/main/java/labfive \
                                     --checkfiles ManipulateDna.java --fragments "charAt" --fragmentcounts 2
  determine_exit_code $?
  # --> GatorGrader CHECK: at least 4 "replace" fragment exists in the code
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/main/java/labfive \
                                     --checkfiles ManipulateDna.java --fragments "replace" --fragmentcounts 4
  determine_exit_code $?
  # --> GatorGrader CHECK: at least 2 "substring" fragment exists in the code
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/main/java/labfive \
                                     --checkfiles ManipulateDna.java --fragments "substring" --fragmentcounts 2
  determine_exit_code $?
